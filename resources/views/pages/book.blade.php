...
@section('title', $book->meta_title)

@section('content')
	<div class="container-box">
		<x-breadcrumbs>{{ $book->title }}</x-breadcrumbs>
	</div>
	<article class="container-box content-wrapper book">
		...
		<div class="center">
			<header>
				...
				<div class="author"><a href="#">Giaccomo Boccio</a> (Autor)</div>
				<div>Rating</div>
				<div class="cart-box">
	...
	<aside class="container-box">
		<div class="content-wrapper">
			<x-book-list.carousel title="Productos relacionados" />
		</div>
		<div class="content-wrapper">
			<x-book-list.carousel title="Productos relacionados" />
		</div>
